...
Join data which holds geometries with the election data:
...
Guadeloupe, Martinique, French Guiana and La Réunion
...
# plot
ggplot() +
  geom_sf(data = (election_ep_rrp %>% filter(regionname %notin% 
                                               c('Guadeloupe', 'La Réunion', 'Guyane', 'Mayotte'))), 
          aes(fill = vote_share))
```
